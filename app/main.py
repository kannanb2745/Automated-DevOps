...
application = app = Flask(__name__, static_folder="styles")
app.secret_key = str("8fc00061972fa46e9cb2d53d2220d6f2")
...
def receive_rfid():
    ...
    if check and check.get("entryStatus"):
        ...
        check = student_data["MetaData"].find_one(
...
# # Scheduler to run the function at 11:59 PM
# def schedule_reset():
#     scheduler = BackgroundScheduler()
#     scheduler.add_job(reset_rfid_data, 'cron', hour=23, minute=59)
#     scheduler.start()
#     print("⏰ Scheduled task to reset RFID data at 11:59 PM")
